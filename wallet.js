...
// --- Contract ki saari jaankari yahan hai (Testnet) ---
const contractAddress = "0xd2AF7dC058ff27Eab04932e6b105676E5C88Dd04";
const contractABI = [
	{
		"inputs": [
			{
                ...
                if (switchError.code === 4902) {
                    try {
                        await walletState.walletClient.addChain({ chain: somniaMainnet });
                         ...
                         showMessage("Please Add Somnia Testnet in MetaMask", "Close", () => document.getElementById('message-box').style.display = 'none');
                         return false;
                    }
                } else {
                    showMessage("Please Switch to Somnia Testnet in MetaMask", "Close", () => document.getElementById('message-box').style.display = 'none');
                    return false;
                }
            }
        }
